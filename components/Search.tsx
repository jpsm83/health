        ...
        {searchResults.length > 0 ? (
          ...
          <div className="relative z-10 flex items-center justify-center h-full mx-3">
            ...
            <div className="text-center text-white max-w-4xl mx-auto px-6">
              ...
              <p className="text-lg md:text-xl text-white max-w-2xl mx-auto drop-shadow-lg" style={{textShadow: '1px 1px 2px rgba(0,0,0,0.8), 0 0 4px rgba(0,0,0,0.4)'}}>
            ...
            <Pagination>
              <PaginationContent>
                ...
                {paginationData.currentPage > 1 && (
                  <PaginationItem>
                    <PaginationPrevious
                      href={`/${locale}/search?q=${encodeURIComponent(query)}&page=${
                        paginationData.currentPage - 1
                      }`}
                    />
                  </PaginationItem>
