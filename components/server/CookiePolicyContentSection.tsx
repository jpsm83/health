...
interface CookiePolicyContentSectionProps {
  locale: string;
}

export default async function CookiePolicyContentSection({
  locale,
}: CookiePolicyContentSectionProps) {
    ...
    <div className="max-w-4xl mx-auto px-4 text-justify">
      ...
      <div className="space-y-8">
        <section>
          ...
          <p className="mb-4">{t("sections.whatAreCookies.paragraphs.0")}</p>
          <p className="mb-4">{t("sections.whatAreCookies.paragraphs.1")}</p>
          <p className="mb-4">{t("sections.whatAreCookies.paragraphs.2")}</p>
        ...
        <section>
          ...
          <p className="mb-6">{t("sections.yourChoices.paragraphs.1")}</p>
