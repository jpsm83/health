...
const emailTranslations = {
  en: {
    ...
    greeting: "Hello",
    message: "Welcome to Women Spot! Please confirm your email address by clicking the button below to complete your account setup.",
    confirmButton: "Confirm Email",
    ignoreMessage: "If you didn't create an account with Women Spot, please ignore this email.",
  ...
  pt: {
    subject: "Confirme seu Email - Women Spot",
    greeting: "Olá",
    message: "Bem-vindo ao Women Spot! Confirme seu endereço de email clicando no botão abaixo para completar a configuração da sua conta.",
    confirmButton: "Confirmar Email",
    ignoreMessage: "Se você não criou uma conta no Women Spot, ignore este email.",
  ...
  es: {
    subject: "Confirma tu Email - Women Spot",
    greeting: "Hola",
    message: "¡Bienvenido a Women Spot! Confirma tu dirección de email haciendo clic en el botón de abajo para completar la configuración de tu cuenta.",
    confirmButton: "Confirmar Email",
    ignoreMessage: "Si no creaste una cuenta en Women Spot, ignora este email.",
  ...
  fr: {
    subject: "Confirmez votre Email - Women Spot",
    greeting: "Bonjour",
    message: "Bienvenue sur Women Spot ! Veuillez confirmer votre adresse e-mail en cliquant sur le bouton ci-dessous pour finaliser la configuration de votre compte.",
    confirmButton: "Confirmer l'Email",
    ignoreMessage: "Si vous n'avez pas créé de compte sur Women Spot, veuillez ignorer cet e-mail.",
  ...
  de: {
    subject: "Bestätigen Sie Ihre E-Mail - Women Spot",
    greeting: "Hallo",
    message: "Willkommen bei Women Spot! Bitte bestätigen Sie Ihre E-Mail-Adresse, indem Sie auf die Schaltfläche unten klicken, um die Einrichtung Ihres Kontos abzuschließen.",
    confirmButton: "E-Mail bestätigen",
    ignoreMessage: "Wenn Sie kein Konto bei Women Spot erstellt haben, ignorieren Sie bitte diese E-Mail.",
  ...
  it: {
    subject: "Conferma il tuo Email - Women Spot",
    greeting: "Ciao",
    message: "Benvenuto su Women Spot! Conferma il tuo indirizzo email cliccando sul pulsante qui sotto per completare la configurazione del tuo account.",
    confirmButton: "Conferma Email",
    ignoreMessage: "Se non hai creato un account su Women Spot, ignora questa email.",
  ...
  nl: {
    subject: "Bevestig uw E-mail - Women Spot",
    greeting: "Hallo",
    message: "Welkom bij Women Spot! Bevestig uw e-mailadres door op de knop hieronder te klikken om de instelling van uw account te voltooien.",
    confirmButton: "E-mail Bevestigen",
    ignoreMessage: "Als u geen account heeft aangemaakt bij Women Spot, negeer dan deze e-mail.",
  ...
  he: {
    subject: "אמת את האימייל שלך - Women Spot",
    greeting: "שלום",
    message: "ברוכים הבאים ל-Women Spot! אנא אמת את כתובת האימייל שלך על ידי לחיצה על הכפתור למטה כדי להשלים את הגדרת החשבון שלך.",
    confirmButton: "אמת אימייל",
    ignoreMessage: "אם לא יצרת חשבון ב-Women Spot, אנא התעלם מהאימייל הזה.",
  ...
  ru: {
    subject: "Подтвердите ваш Email - Women Spot",
    greeting: "Привет",
    message: "Добро пожаловать в Women Spot! Пожалуйста, подтвердите ваш адрес электронной почты, нажав кнопку ниже, чтобы завершить настройку вашего аккаунта.",
    confirmButton: "Подтвердить Email",
    ignoreMessage: "Если вы не создавали аккаунт в Women Spot, проигнорируйте это письмо.",
